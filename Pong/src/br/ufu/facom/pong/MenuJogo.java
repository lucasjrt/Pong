...
public class MenuJogo extends Menu{
	...
	public int[] selecionado = {2, 0, 1, 1}; // Posição do vetor de cada opção que está selecionada
	public int atual = 0; // Opção do menu selecionada para ser modificada
	private boolean multiplayer = false;
	
	private TecladoMenu teclado = new TecladoMenu(this);
	...
	public void submeter() {
		...
		switch (selecionado[1]) {
			...
			case 2:
				...
				MenuMultiplayer mm = new MenuMultiplayer();
				mm.frame.dispose();
				frame.setVisible(true);
				ds = mm.getDatagramSocket();
				if(ds == null)
					return;
				break;
			default:
